  ...
  pt: {
    translations: {
      ...
      aiAgents: {
        ...
        modal: {
          addTitle: "Adicionar Agente de IA",
        ...
        form: {
          ...
          responseInterval: "Intervalo de Resposta (ms)",
          isActive: "Ativo",
        },
        confirmationModal: {
        ...
        toasts: {
          created: "Agente de IA criado com sucesso!",
          updated: "Agente de IA atualizado com sucesso!",
          deleted: "Agente de IA excluído com sucesso!",
        },
      },
      contactModal: {
        title: {
