    ...
    const theme = createTheme(
        {
            ...
            palette: {
                type: mode,
                primary: { main: mode === "light" ? "#1DCC91" : "#FFFFFF" },
                textPrimary: mode === "light" ? "#1DCC91" : "#FFFFFF",
                borderPrimary: mode === "light" ? "#1DCC91" : "#FFFFFF",
                ...
                barraSuperior: mode === "light" ? "linear-gradient(to right, #1DCC91, #1DCC91 , #1DCC91)" : "#666",
