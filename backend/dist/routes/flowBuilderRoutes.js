...
flowBuilder.post("/flowbuilder/config/:flowId", isAuth_1.default, FlowBuilderController.saveFlowConfig);
flowBuilder.get("/flowbuilder/config/:flowId", isAuth_1.default, FlowBuilderController.getFlowConfig);
